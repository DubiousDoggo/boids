...
=======
  82368: $0 => {
>>>>>>> 25f3063bb57b9cc6567d4633a5c37636ec79438d
...
<<<<<<< HEAD
  91154: () => window.innerWidth,
  91184: () => window.innerHeight
=======
  91170: () => window.innerWidth,
  91200: () => window.innerHeight
>>>>>>> 25f3063bb57b9cc6567d4633a5c37636ec79438d
};
...
var wasmImports = {
  ...
  /** @export */ xd: ___syscall_ioctl,
  /** @export */ wd: ___syscall_openat,
  /** @export */ vd: ___syscall_stat64,
  /** @export */ qd: __abort_js,
  /** @export */ pd: __tzset_js,
  /** @export */ od: _eglBindAPI,
  /** @export */ nd: _eglChooseConfig,
  /** @export */ md: _eglCreateContext,
  /** @export */ ld: _eglCreateWindowSurface,
  /** @export */ kd: _eglDestroyContext,
  /** @export */ jd: _eglDestroySurface,
  /** @export */ id: _eglGetConfigAttrib,
  /** @export */ I: _eglGetDisplay,
  /** @export */ hd: _eglGetError,
  /** @export */ gd: _eglInitialize,
  /** @export */ fd: _eglMakeCurrent,
  /** @export */ ed: _eglQueryString,
  /** @export */ dd: _eglSwapBuffers,
  /** @export */ cd: _eglSwapInterval,
  /** @export */ bd: _eglTerminate,
  /** @export */ ad: _eglWaitGL,
  /** @export */ $c: _eglWaitNative,
  /** @export */ _c: _emscripten_asm_const_int,
  /** @export */ a: _emscripten_asm_const_int_sync_on_main_thread,
  /** @export */ H: _emscripten_asm_const_ptr_sync_on_main_thread,
  /** @export */ Zc: _emscripten_cancel_main_loop,
  /** @export */ Yc: _emscripten_date_now,
  /** @export */ Xc: _emscripten_exit_fullscreen,
  /** @export */ Wc: _emscripten_exit_pointerlock,
  /** @export */ Vc: _emscripten_force_exit,
  /** @export */ d: _emscripten_get_device_pixel_ratio,
  /** @export */ b: _emscripten_get_element_css_size,
  /** @export */ G: _emscripten_get_gamepad_status,
  /** @export */ F: _emscripten_get_now,
  /** @export */ Uc: _emscripten_get_num_gamepads,
  /** @export */ Tc: _emscripten_get_screen_size,
  /** @export */ Sc: _emscripten_glActiveTexture,
  /** @export */ Rc: _emscripten_glAttachShader,
  /** @export */ Qc: _emscripten_glBeginQueryEXT,
  /** @export */ Pc: _emscripten_glBindAttribLocation,
  /** @export */ Oc: _emscripten_glBindBuffer,
  /** @export */ Nc: _emscripten_glBindFramebuffer,
  /** @export */ Mc: _emscripten_glBindRenderbuffer,
  /** @export */ Lc: _emscripten_glBindTexture,
  /** @export */ Kc: _emscripten_glBindVertexArrayOES,
  /** @export */ Jc: _emscripten_glBlendColor,
  /** @export */ Ic: _emscripten_glBlendEquation,
  /** @export */ Hc: _emscripten_glBlendEquationSeparate,
  /** @export */ Gc: _emscripten_glBlendFunc,
  /** @export */ Fc: _emscripten_glBlendFuncSeparate,
  /** @export */ Ec: _emscripten_glBufferData,
  /** @export */ Dc: _emscripten_glBufferSubData,
  /** @export */ Cc: _emscripten_glCheckFramebufferStatus,
  /** @export */ Bc: _emscripten_glClear,
  /** @export */ Ac: _emscripten_glClearColor,
  /** @export */ zc: _emscripten_glClearDepthf,
  /** @export */ yc: _emscripten_glClearStencil,
  /** @export */ xc: _emscripten_glClipControlEXT,
  /** @export */ wc: _emscripten_glColorMask,
  /** @export */ vc: _emscripten_glCompileShader,
  /** @export */ uc: _emscripten_glCompressedTexImage2D,
  /** @export */ tc: _emscripten_glCompressedTexSubImage2D,
  /** @export */ sc: _emscripten_glCopyTexImage2D,
  /** @export */ rc: _emscripten_glCopyTexSubImage2D,
  /** @export */ qc: _emscripten_glCreateProgram,
  /** @export */ pc: _emscripten_glCreateShader,
  /** @export */ oc: _emscripten_glCullFace,
  /** @export */ nc: _emscripten_glDeleteBuffers,
  /** @export */ mc: _emscripten_glDeleteFramebuffers,
  /** @export */ lc: _emscripten_glDeleteProgram,
  /** @export */ kc: _emscripten_glDeleteQueriesEXT,
  /** @export */ jc: _emscripten_glDeleteRenderbuffers,
  /** @export */ ic: _emscripten_glDeleteShader,
  /** @export */ hc: _emscripten_glDeleteTextures,
  /** @export */ gc: _emscripten_glDeleteVertexArraysOES,
  /** @export */ fc: _emscripten_glDepthFunc,
  /** @export */ ec: _emscripten_glDepthMask,
  /** @export */ dc: _emscripten_glDepthRangef,
  /** @export */ cc: _emscripten_glDetachShader,
  /** @export */ bc: _emscripten_glDisable,
  /** @export */ ac: _emscripten_glDisableVertexAttribArray,
  /** @export */ $b: _emscripten_glDrawArrays,
  /** @export */ _b: _emscripten_glDrawArraysInstancedANGLE,
  /** @export */ Zb: _emscripten_glDrawBuffersWEBGL,
  /** @export */ Yb: _emscripten_glDrawElements,
  /** @export */ Xb: _emscripten_glDrawElementsInstancedANGLE,
  /** @export */ Wb: _emscripten_glEnable,
  /** @export */ Vb: _emscripten_glEnableVertexAttribArray,
  /** @export */ Ub: _emscripten_glEndQueryEXT,
  /** @export */ Tb: _emscripten_glFinish,
  /** @export */ Sb: _emscripten_glFlush,
  /** @export */ Rb: _emscripten_glFramebufferRenderbuffer,
  /** @export */ Qb: _emscripten_glFramebufferTexture2D,
  /** @export */ Pb: _emscripten_glFrontFace,
  /** @export */ Ob: _emscripten_glGenBuffers,
  /** @export */ Nb: _emscripten_glGenFramebuffers,
  /** @export */ Mb: _emscripten_glGenQueriesEXT,
  /** @export */ Lb: _emscripten_glGenRenderbuffers,
  /** @export */ Kb: _emscripten_glGenTextures,
  /** @export */ Jb: _emscripten_glGenVertexArraysOES,
  /** @export */ Ib: _emscripten_glGenerateMipmap,
  /** @export */ Hb: _emscripten_glGetActiveAttrib,
  /** @export */ Gb: _emscripten_glGetActiveUniform,
  /** @export */ Fb: _emscripten_glGetAttachedShaders,
  /** @export */ Eb: _emscripten_glGetAttribLocation,
  /** @export */ Db: _emscripten_glGetBooleanv,
  /** @export */ Cb: _emscripten_glGetBufferParameteriv,
  /** @export */ Bb: _emscripten_glGetError,
  /** @export */ Ab: _emscripten_glGetFloatv,
  /** @export */ zb: _emscripten_glGetFramebufferAttachmentParameteriv,
  /** @export */ yb: _emscripten_glGetIntegerv,
  /** @export */ xb: _emscripten_glGetProgramInfoLog,
  /** @export */ wb: _emscripten_glGetProgramiv,
  /** @export */ vb: _emscripten_glGetQueryObjecti64vEXT,
  /** @export */ ub: _emscripten_glGetQueryObjectivEXT,
  /** @export */ tb: _emscripten_glGetQueryObjectui64vEXT,
  /** @export */ sb: _emscripten_glGetQueryObjectuivEXT,
  /** @export */ rb: _emscripten_glGetQueryivEXT,
  /** @export */ qb: _emscripten_glGetRenderbufferParameteriv,
  /** @export */ pb: _emscripten_glGetShaderInfoLog,
  /** @export */ ob: _emscripten_glGetShaderPrecisionFormat,
  /** @export */ nb: _emscripten_glGetShaderSource,
  /** @export */ mb: _emscripten_glGetShaderiv,
  /** @export */ lb: _emscripten_glGetString,
  /** @export */ kb: _emscripten_glGetTexParameterfv,
  /** @export */ jb: _emscripten_glGetTexParameteriv,
  /** @export */ ib: _emscripten_glGetUniformLocation,
  /** @export */ hb: _emscripten_glGetUniformfv,
  /** @export */ gb: _emscripten_glGetUniformiv,
  /** @export */ fb: _emscripten_glGetVertexAttribPointerv,
  /** @export */ eb: _emscripten_glGetVertexAttribfv,
  /** @export */ db: _emscripten_glGetVertexAttribiv,
  /** @export */ cb: _emscripten_glHint,
  /** @export */ bb: _emscripten_glIsBuffer,
  /** @export */ ab: _emscripten_glIsEnabled,
  /** @export */ $a: _emscripten_glIsFramebuffer,
  /** @export */ _a: _emscripten_glIsProgram,
  /** @export */ Za: _emscripten_glIsQueryEXT,
  /** @export */ Ya: _emscripten_glIsRenderbuffer,
  /** @export */ Xa: _emscripten_glIsShader,
  /** @export */ Wa: _emscripten_glIsTexture,
  /** @export */ Va: _emscripten_glIsVertexArrayOES,
  /** @export */ Ua: _emscripten_glLineWidth,
  /** @export */ Ta: _emscripten_glLinkProgram,
  /** @export */ Sa: _emscripten_glPixelStorei,
  /** @export */ Ra: _emscripten_glPolygonModeWEBGL,
  /** @export */ Qa: _emscripten_glPolygonOffset,
  /** @export */ Pa: _emscripten_glPolygonOffsetClampEXT,
  /** @export */ Oa: _emscripten_glQueryCounterEXT,
  /** @export */ Na: _emscripten_glReadPixels,
  /** @export */ Ma: _emscripten_glReleaseShaderCompiler,
  /** @export */ La: _emscripten_glRenderbufferStorage,
  /** @export */ Ka: _emscripten_glSampleCoverage,
  /** @export */ Ja: _emscripten_glScissor,
  /** @export */ Ia: _emscripten_glShaderBinary,
  /** @export */ Ha: _emscripten_glShaderSource,
  /** @export */ Ga: _emscripten_glStencilFunc,
  /** @export */ Fa: _emscripten_glStencilFuncSeparate,
  /** @export */ Ea: _emscripten_glStencilMask,
  /** @export */ Da: _emscripten_glStencilMaskSeparate,
  /** @export */ Ca: _emscripten_glStencilOp,
  /** @export */ Ba: _emscripten_glStencilOpSeparate,
  /** @export */ Aa: _emscripten_glTexImage2D,
  ...
  /** @export */ $: _emscripten_glVertexAttrib1f,
  /** @export */ _: _emscripten_glVertexAttrib1fv,
  /** @export */ Z: _emscripten_glVertexAttrib2f,
  /** @export */ Y: _emscripten_glVertexAttrib2fv,
  /** @export */ X: _emscripten_glVertexAttrib3f,
  /** @export */ W: _emscripten_glVertexAttrib3fv,
  /** @export */ V: _emscripten_glVertexAttrib4f,
  /** @export */ U: _emscripten_glVertexAttrib4fv,
  /** @export */ T: _emscripten_glVertexAttribDivisorANGLE,
  /** @export */ S: _emscripten_glVertexAttribPointer,
  /** @export */ R: _emscripten_glViewport,
  /** @export */ g: _emscripten_has_asyncify,
  /** @export */ Q: _emscripten_request_fullscreen_strategy,
  /** @export */ E: _emscripten_request_pointerlock,
  /** @export */ P: _emscripten_resize_heap,
  /** @export */ D: _emscripten_sample_gamepad_data,
  /** @export */ C: _emscripten_set_beforeunload_callback_on_thread,
  /** @export */ B: _emscripten_set_blur_callback_on_thread,
  /** @export */ c: _emscripten_set_canvas_element_size,
  /** @export */ f: _emscripten_set_element_css_size,
  /** @export */ A: _emscripten_set_focus_callback_on_thread,
  /** @export */ z: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ y: _emscripten_set_gamepadconnected_callback_on_thread,
  /** @export */ x: _emscripten_set_gamepaddisconnected_callback_on_thread,
  /** @export */ w: _emscripten_set_keydown_callback_on_thread,
  /** @export */ v: _emscripten_set_keypress_callback_on_thread,
  /** @export */ u: _emscripten_set_keyup_callback_on_thread,
  /** @export */ O: _emscripten_set_main_loop,
  /** @export */ t: _emscripten_set_mousedown_callback_on_thread,
  /** @export */ s: _emscripten_set_mouseenter_callback_on_thread,
  /** @export */ r: _emscripten_set_mouseleave_callback_on_thread,
  ...
  /** @export */ m: _emscripten_set_touchcancel_callback_on_thread,
  /** @export */ l: _emscripten_set_touchend_callback_on_thread,
  /** @export */ k: _emscripten_set_touchmove_callback_on_thread,
  /** @export */ j: _emscripten_set_touchstart_callback_on_thread,
  /** @export */ i: _emscripten_set_visibilitychange_callback_on_thread,
  /** @export */ h: _emscripten_set_wheel_callback_on_thread,
  /** @export */ N: _emscripten_set_window_title,
  /** @export */ e: _emscripten_sleep,
  /** @export */ ud: _environ_get,
  /** @export */ td: _environ_sizes_get,
  /** @export */ K: _fd_close,
  /** @export */ sd: _fd_read,
  /** @export */ rd: _fd_seek,
  /** @export */ J: _fd_write
...
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["Bd"])(a0, a1);

var _malloc = a0 => (_malloc = wasmExports["Cd"])(a0);

var __emscripten_stack_restore = a0 => (__emscripten_stack_restore = wasmExports["Dd"])(a0);

var __emscripten_stack_alloc = a0 => (__emscripten_stack_alloc = wasmExports["Ed"])(a0);

var _emscripten_stack_get_current = () => (_emscripten_stack_get_current = wasmExports["Fd"])();
